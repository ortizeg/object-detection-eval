...
class Config(MyConfig):
    def __init__(self):
        ...
        # --- Basketball finetune overrides ---
        self.model.head["num_classes"] = 11
        self.train.batch_size = 16
        self.train.total_epochs = 120
        self.train.finetune_path = "/workspace/damoyolo_tinynasL35_M.pth"
        self.dataset.train_ann = ("basketball_train_coco",)
        self.dataset.val_ann = ("basketball_val_coco",)
        self.dataset.class_names = [
            "basketball",
            "ball",
            "ball-in-basket",
