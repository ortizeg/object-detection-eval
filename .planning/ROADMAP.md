...
- [ ] 03-01-PLAN.md — Model card schema + registry loader: frozen, extra=forbid ModelCard with a required preprocessing block and load-time redistribution validation (REG-01, REG-02) [wave 1]
- [ ] 03-02-PLAN.md — SHA-256-verified download_weights + WeightsNotRedistributableError for AGPL cards (REG-03, REG-04) [wave 2, depends 03-01]
- [ ] 03-03-PLAN.md — 10 model cards (8 with weights, 2 AGPL with reproduction) + publish_weights.py HF publisher, mocked (REG-05, REG-06) [wave 3, depends 03-01, 03-02]
...
| 3. Model Registry | 0/3 | Not started | - |
